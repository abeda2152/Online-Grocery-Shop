...
<div class="container" style="margin-top:60px"> 
	<?php $que=mysqli_query($conn,"select * from products");
		...
		if($row['cat'] == $a){
			...
			<div class="col-sm-4">
      			<div class="panel panel-primary">
        			<div class="panel-heading" style="background:darkslategray"><?php echo $row['name']?><p style="text-align: right;"><a href="add_cart.php">Add to cart</p></a></div>
